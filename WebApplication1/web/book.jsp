                ...
                <tbody>
                    ...
                    <c:forEach items="${listBookAttribute}" var="listBook">
                        <tr><td>${listBook.getBookId()}</td>
                            ...
                            <td>
                                <a href="" id="editBtn${listBook.getBookId()}" data-toggle="modal" data-target="#editBookModal" class="edit" value="${listBook.getBookId()}" title="Edit"><i class="material-icons">&#xE254;</i></a>
                            </td>
                            <td>
