...
<table>
    ...
    <tbody>
        <tr><th>S.C.ID</th><th>S.C.Name</th><th>Edit</th><th>Delete</th></tr>
    

  <%  DatabaseConnection dbConnection=new DatabaseConnection();
        try{Connection con=dbConnection.getConnection();
        Statement statement=con.createStatement();
        String query="select * from sub_class";
        ResultSet rs=statement.executeQuery(query);
        while(rs.next()){
            %>
            <tr><td><%=rs.getString("s_C_ID")%></td>
            <td><%=rs.getString("S_C_name")%></td>
                       <td>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form role="form" method="post" id="reused_form" action="SCcontroller" >
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="mainclassification" class="form-control" onChange="selectvalue(form);" >
                                     <c:forEach items="${mainClassificationList}" var="mainstatus" >
                                     <option value="${mainstatus}" <c:if test="${mainstatus eq mainclassifications}">Selected="True"</c:if>    size="35">${mainstatus}</option>
                                       </c:forEach>
                                       </select>
